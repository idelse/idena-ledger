...
build: build_rust
	...
	@cp $(LEDGER_SRC)/nanos_app_idena.gif $(LEDGER_SRC)/glyphs/icon_app.gif
	$(info calling make inside docker)
	$(call run_docker,$(DOCKER_BOLOS_SDK),make -C $(DOCKER_APP_SRC))

buildX: build_rust
	@cp $(LEDGER_SRC)/nanos_app_idena.gif $(LEDGER_SRC)/glyphs/icon_app.gif
	@convert $(LEDGER_SRC)/nanos_app_idena.gif -crop 14x14+1+1 +repage -negate $(LEDGER_SRC)/nanox_icon.gif
